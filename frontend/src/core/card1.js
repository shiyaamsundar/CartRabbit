...
import { deleteroom } from './helper/coreapi';
    ...
    return (
        ...
        <p className="pt-2">{cardemail}</p>
              ...
              <div className="row">
                ...
                <Link className="btn text-white" to={`/admin/edit/${room._id}`}><h4>Edit Room</h4></Link>
                <Link className="btn text-white" to={`/admin/delete/${room._id}`}><h4>Delete Room</h4></Link>
